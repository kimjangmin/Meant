 ...
 */
public class Dialog_Heart3 extends Dialog implements View.OnClickListener {
    Button bt1,bt2;
    Button b1,b2,b3,b4;
    Context act;
    View view;
    ...
    public Dialog_Heart3(Context context,View view, int position, TestRecyclerViewAdapter3 trva3, FeedItem fid, RecyclerView.Adapter mAdapter, int flag)
    {
        super(context);
    ...
    public void onClick(View v) {
        if(v == bt1)
        {
            RecyclerViewFragment_3 r3 = new RecyclerViewFragment_3();
            r3.push_yes(view, position, trva3, fid, mAdapter);
            dismiss();
