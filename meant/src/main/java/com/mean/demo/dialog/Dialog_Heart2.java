 ...
 */
public class Dialog_Heart2 extends Dialog implements View.OnClickListener {
    Button bt1,bt2;
    Button b1,b2,b3,b4;
    Context act;
    View view;
    ...
    public Dialog_Heart2(Context context,View view, int position, TestRecyclerViewAdapter2 trva2, FeedItem fid, RecyclerView.Adapter mAdapter,int flag)
    {
        super(context);
    ...
    public void onClick(View v) {
        if(v == bt1)
        {
            RecyclerViewFragment_2 r2 = new RecyclerViewFragment_2();
            r2.push_yes(view, position, trva2, fid, mAdapter);
            dismiss();
