 ...
 */
public class Dialog_Heart extends Dialog implements View.OnClickListener {
    Button bt1,bt2;
    Button b1,b2,b3,b4;
    Context act;
    View view;
    ...
    public Dialog_Heart(Context context,View view, int position, TestRecyclerViewAdapter trva, FeedItem fid, RecyclerView.Adapter mAdapter,int flag)
    {
        super(context);
    ...
    public void onClick(View v) {
        if(v == bt1)
        {
            ...
            r.push_yes(view, position, trva, fid, mAdapter);
            dismiss();
